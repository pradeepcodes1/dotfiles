...
_cpt_stress() {
    # Default filenames
    local sol_file="main.cpp"; local brute_file="brute.cpp"; local gen_file="gen.cpp"
    
    local sol_path="$CP_HOME/src/$sol_file"; local brute_path="$CP_HOME/src/$brute_file"; local gen_path="$CP_HOME/src/$gen_file"
    
    local sol_exe="$CP_HOME/build/${sol_file%.cpp}"; local brute_exe="$CP_HOME/build/${brute_file%.cpp}"; local gen_exe="$CP_HOME/build/${gen_file%.cpp}"
